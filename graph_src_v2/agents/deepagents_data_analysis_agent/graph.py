...
def _format_model_credential_error(exc: BaseException) -> str:
    return (
        "Deep data-analysis model authentication failed. "
...
def _format_model_connection_error(exc: BaseException) -> str:
    return (
        "Deep data-analysis model connection failed. "
...
_builder.add_node("run_data_analysis", _run_data_analysis)
_builder.add_edge(START, "run_data_analysis")
_builder.add_edge("run_data_analysis", END)

graph = _builder.compile(name="deepagents_data_analysis_demo")
